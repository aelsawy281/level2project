        ...
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('admin.login') }}" >
          @csrf
            ...
            <div class="form-group">
                ...
                <input type="email" id="inputEmail" class="form-control form-control-lg" placeholder="Email address" required="" autofocus="" name="email" :value="old('email')">
            ...
            <label>
                <input type="checkbox" name="remember" value="remember-me">StayLoggedin</label>
            </div>
